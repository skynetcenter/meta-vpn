...
#Switch to uninstall kernel version
gototcp() {
  clear
...
start_menu() {
  clear
  echo && echo -e " TCP acceleration one-click installation management script ${Red_font_prefix}[v${sh_ver}] Do not uninstall the kernel${Font_color_suffix} from blog.ylx.me
 ${Green_font_prefix}0.${Font_color_suffix} Upgrade script
 ${Green_font_prefix}9.${Font_color_suffix} Switch to uninstall kernel version		${Green_font_prefix}10.${Font_color_suffix} Switch to one-click DD system script
 ${Green_font_prefix}1.${Font_color_suffix} Install BBR original kernel		${Green_font_prefix}7.${Font_color_suffix} Install Zen official kernel
 ${Green_font_prefix}2.${Font_color_suffix} Install BBRplus kernel		${Green_font_prefix}5.${Font_color_suffix} Install BBRplus new kernel
 ${Green_font_prefix}3.${Font_color_suffix} Install the Lotserver (Sharp Speed) kernel	${Green_font_prefix}6.${Font_color_suffix} Install the xanmod version of the kernel
 ${Green_font_prefix}30.${Font_color_suffix} Install official stable kernel		${Green_font_prefix}31.${Font_color_suffix} Install official latest kernel backports/elrepo
 ${Green_font_prefix}32.${Font_color_suffix} Install XANMOD official kernel	${Green_font_prefix}33.${Font_color_suffix} Install XANMOD official high-response kernel
 ...
 ${Green_font_prefix}17.${Font_color_suffix} Turn on ECN	 		${Green_font_prefix}18.${Font_color_suffix} Turn off ECN
 ${Green_font_prefix}19.${Font_color_suffix} Use BBRplus+FQ to accelerate       ${Green_font_prefix}20.${Font_color_suffix} Use Lotserver (sharp speed) to accelerate
 ${Green_font_prefix}21.${Font_color_suffix} System configuration optimization	 	${Green_font_prefix}22.${Font_color_suffix} Apply johnrosen1's optimization scheme
 ${Green_font_prefix}23.${Font_color_suffix}  Disable IPv6	 		${Green_font_prefix}24.${Font_color_suffix}  Enable IPv6
 ${Green_font_prefix}51.${Font_color_suffix} View kernels               ${Green_font_prefix}52.${Font_color_suffix} Delete and keep specified kernels
 ${Green_font_prefix}25.${Font_color_suffix} Uninstall all accelerators	 	${Green_font_prefix}99.${Font_color_suffix} Exit script 
————————————————————————————————————————————————————————————————" &&
    check_status
  get_system_info
  ...
  *)
    clear
    echo -e "${Error}:Enter a valid option [0-99]"
    sleep 5s
    start_menu
    ;;
  esac
